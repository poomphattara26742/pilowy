...
<div class="p-2">
     ...
     <button class="btn_sortby  ml-auto mr-auto dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         ราคา</button>
...
<br><br>
  ...
  <div class="card-grid">
       ...
       <div class="content">
           ...
           <a href="single-product1.php?id=1" class="Btn_BuyProduct ml-auto mr-auto">สั่งซื้อสินค้า</a>
      </div>
     </div>
     ...
     <div class="content">
        <h4 class="Txt_ProductName">Heart/Durian</h4>
           ...
           <a href="single-product2.php?id=2" class="Btn_BuyProduct ml-auto mr-auto">สั่งซื้อสินค้า</a>
      </div>
     </div>
     ...
     <div class="content">
        <h4 class="Txt_ProductName">Massage/Knobby</h4>
           ...
           <h1 class="Txt_price">777 บาท</h1><br>
           <a href="single-product3.php?id=3" class="Btn_BuyProduct ml-auto mr-auto">สั่งซื้อสินค้า</a>
      </div>
     </div>
